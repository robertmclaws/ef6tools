...
namespace Microsoft.Data.Entity.Design.UI.ViewModels.Explorer
{
    ...
    internal class EntityDesignExplorerViewModelHelper : ExplorerViewModelHelper
    {
        ...
        public override void CreateViewModel(EditingContext ctx)
        {
            ...
            ExplorerRootNode edmRootNode = new ExplorerRootNode(ctx, null, artifact.Uri);

            var designerInfo = artifact.DesignerInfo();
            if (designerInfo != null
                && designerInfo.Diagrams != null)
            {
                ExplorerDiagrams explorerDiagrams = (ExplorerDiagrams)
            ...
            {
                ExplorerConceptualEntityModel browserCsdlEntityModel = (ExplorerConceptualEntityModel)
                                             ModelToExplorerModelXRef.GetNewOrExisting(
            ...
            {
                ExplorerStorageEntityModel browserSsdlEntityModel = (ExplorerStorageEntityModel)
                                             ModelToExplorerModelXRef.GetNewOrExisting(
        ...
        {
            EFArtifact artifact = change.Changed as EFArtifact;

            ConceptualEntityModel conceptualModel = change.Changed as ConceptualEntityModel;
            StorageEntityModel storageModel = change.Changed as StorageEntityModel;
            MappingModel mappingModel = change.Changed as MappingModel;
            if (null != artifact
                ||
                ...
                null != mappingModel)
            {
                ...
                ExplorerSearchResults explorerSearchResults = ExplorerSearchResults.GetExplorerSearchResults(ctx);
            ...
            if (change.Changed is EFElement efElement)
            {
                EFElement parent = efElement.Parent as EFElement;
                Debug.Assert(
                    null != parent,
                ...
                if (null != parent)
                {
                    ...
                    Key keyElement = efElement as Key;
                    if (efElement is PropertyRef propRef)
                    {
        ...
        internal static EFElement GetNavigationTargetForEFObject(EFObject efObject)
        {
            ...
            PropertyRef propertyRef = efElement as PropertyRef;
            PropertyRefContainer propertyRefContainer = efElement as PropertyRefContainer;
            if (propertyRef != null
        ...
        public void CreateFunctionImport(Function sproc)
        {
            ...
            if (root.ConceptualModel.ModelItem is not ConceptualEntityModel cModel)
            {
            ...
            if (root.StorageModel.ModelItem is not StorageEntityModel sModel)
            {
