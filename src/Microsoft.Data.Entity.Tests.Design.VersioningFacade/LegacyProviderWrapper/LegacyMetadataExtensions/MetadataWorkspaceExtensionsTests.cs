...
namespace Microsoft.Data.Entity.Tests.Design.VersioningFacade.LegacyProviderWrapper.LegacyMetadataExtensions
{
    ...
    {
        [TestMethod, Ignore("Differences between official dll and locally built one")]
        public void ToLegacyMetadataWorkspace_creates_equivalent_legacy_MetadataWorkspace_for_all_versions()
        {
            ...
            foreach (var version in EntityFrameworkVersion.GetAllVersions())
            {
                ...
                legacyWorkspace.Should().NotBeNull();
