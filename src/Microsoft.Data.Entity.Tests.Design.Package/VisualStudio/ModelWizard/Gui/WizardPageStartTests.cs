...
namespace Microsoft.Data.Entity.Tests.Design.VisualStudio.ModelWizard.Gui
{
    ...
    public class WizardPageStartTests
    {
        ...
        public void OnDeactivate_does_not_update_settings_if_model_file_already_exists()
        {
            ...
            modelBuilderSettings.ModelPath.Should().BeNull();
            wizard.FileAlreadyExistsError.Should().BeTrue();
        }
        ...
        public void OnDeactivate_updates_model_settings_if_model_file_does_not_exist_for_empty_model()
        {
            ...
            modelBuilderSettings.GenerationOption.Should().Be(ModelGenerationOption.EmptyModel);
            wizard.FileAlreadyExistsError.Should().BeFalse();
            modelBuilderSettings.ModelPath.Should().Be(@"C:\temp\myModel.edmx");
            modelBuilderSettings.ReplacementDictionary.Any().Should().BeTrue();
            modelBuilderSettings.ModelBuilderEngine.Should().BeNull();
        }
        ...
        public void OnDeactivate_updates_model_settings_if_model_file_does_not_exist_for_generate_from_database()
        {
            ...
            modelBuilderSettings.GenerationOption.Should().Be(ModelGenerationOption.GenerateFromDatabase);
            wizard.FileAlreadyExistsError.Should().BeFalse();
            modelBuilderSettings.ModelPath.Should().Be(@"C:\temp\myModel.edmx");
            // replacement dictionary updated lazily
            modelBuilderSettings.ReplacementDictionary.Any().Should().BeFalse();
            modelBuilderSettings.ModelBuilderEngine.Should().BeOfType<EdmxModelBuilderEngine>();
...
@"<configuration>
  <connectionStrings>
    <add name=""myModel"" connectionString=""Data Source=(localdb)\MSSQLLocalDB;"" providerName=""System.Data.SqlClient"" />
            ...
            modelBuilderSettings.GenerationOption.Should().Be(ModelGenerationOption.EmptyModelCodeFirst);
            wizard.FileAlreadyExistsError.Should().BeFalse();
            modelBuilderSettings.ModelPath.Should().Be(@"C:\temp\myModel.cs");
            modelBuilderSettings.ReplacementDictionary.Count.Should().Be(1);
            modelBuilderSettings.ReplacementDictionary["$rootnamespace$"].Should().Be("modelNamespace");
            modelBuilderSettings.ModelBuilderEngine.Should().BeNull();
            modelBuilderSettings.AppConfigConnectionPropertyName.Should().Be(@"myModel1");
            modelBuilderSettings.SaveConnectionStringInAppConfig.Should().BeTrue();
            modelBuilderSettings.AppConfigConnectionString.Should().Be(
        ...
        public void OnDeactivate_updates_model_settings_if_model_file_does_not_exist_for_CodeFirst_from_database()
        {
            ...
            var modelBuilderSettings = wizard.ModelBuilderSettings;
            modelBuilderSettings.GenerationOption.Should().Be(ModelGenerationOption.CodeFirstFromDatabase);
            wizard.FileAlreadyExistsError.Should().BeFalse();
            modelBuilderSettings.ModelPath.Should().Be(@"C:\temp\myModel.cs");
            modelBuilderSettings.ReplacementDictionary.Any().Should().BeFalse();
            modelBuilderSettings.ModelBuilderEngine.Should().BeOfType<CodeFirstModelBuilderEngine>();
        }
        ...
        public void OnActivate_result_depends_on_FileAlreadyExistsError()
        {
            ...
            wizardPageStart.OnActivate().Should().BeTrue();
        }
