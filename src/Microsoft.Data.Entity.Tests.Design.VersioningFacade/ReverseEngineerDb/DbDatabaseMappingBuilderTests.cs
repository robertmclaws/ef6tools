...
namespace Microsoft.Data.Entity.Tests.Design.VersioningFacade.ReverseEngineerDb
{
    ...
    public class DbDatabaseMappingBuilderTests
    {
        ...
        public void Build_builds_valid_DbDatabaseMapping_for_entity_types()
        {
            ...
            //dbMapping.Database.Should().BeSameAs(storeModel);
            //var entityContainerMapping = dbMapping.EntityContainerMappings.Single();
            //entityContainerMapping.StorageEntityContainer.Should().BeSameAs(storeContainer);
            //entityContainerMapping.EdmEntityContainer.Should().BeSameAs(modelContainer);
            //Assert.Equal(1, entityContainerMapping.EntitySetMappings.Count());

            //dbMapping.Model.Should().NotBeNull();
        ...
        public void BuildEntitySetMapping_creates_valid_entity_set_mapping()
        {
            ...
            //entitySetMapping.EntitySet.Should().BeSameAs(modelEntitySet);
            //Assert.Equal(1, entitySetMapping.EntityTypeMappings.Count());
        }

        [TestMethod, Ignore("Different API Visibilty between ")]
        public void BuildEntityMapping_creates_valid_entity_mappings()
        {
            ...
            //typeMapping.EntityType.Should().BeSameAs(modelEntityType);
            //typeMapping.MappingFragments.Count.Should().Be(1);
            //var mappingFragment = typeMapping.MappingFragments.Single();
            //mappingFragment.Table.Should().Be(storeEntityType);
        ...
        public static void BuildAssociationSetMappings_creates_valid_association_set_mappings()
        {
            ...
            //setMapping.Set.Name.Should().Be("modelAS");
            //setMapping.Table.Name.Should().Be("storeET2");
            ...
            //setMapping.SourceEndMapping.AssociationEnd.Name.Should().Be("modelEM1");
            //setMapping.TargetEndMapping.AssociationEnd.Name.Should().Be("modelEM2");
            //setMapping.SourceEndMapping.PropertyMappings.Count.Should().Be(1);
            //setMapping.TargetEndMapping.PropertyMappings.Count.Should().Be(1);
            //setMapping.SourceEndMapping.PropertyMappings[0].Property.Name.Should().Be("modelSourceId");
            //setMapping.TargetEndMapping.PropertyMappings[0].Property.Name.Should().Be("modelTargetId");
        ...
        public void BuildAssociationSetMappings_builds_conceptual_assocation_set_mapping_for_collapsed_store_entity_sets()
        {
            ...
            //scalarPropertyMapping.Property.Should().BeSameAs(conceptualTeacherEntityType.KeyMembers.Single());
            //Assert.Same(
            ...
            //scalarPropertyMapping.Property.Should().BeSameAs(conceptualStudentEntityType.KeyMembers.Single());
            //Assert.Same(
        ...
        public void BuildComposableFunctionMapping_creates_valid_function_mapping()
        {
            ...
            //functionImportMapping.Should().NotBeNull();
            //functionImportMapping.TargetFunction.Should().BeSameAs(storeFunction);
            //functionImportMapping.FunctionImport.Should().BeSameAs(functionImport);

            //var structuralTypeMappings = functionImportMapping.StructuralTypeMappings;
            //structuralTypeMappings.Should().NotBeNull();
