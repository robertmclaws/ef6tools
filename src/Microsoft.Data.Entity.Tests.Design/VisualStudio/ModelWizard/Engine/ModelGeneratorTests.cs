...
namespace Microsoft.Data.Entity.Tests.Design.VisualStudio.ModelWizard.Engine
{
    ...
    public class ModelGeneratorTests
    {
        ...
        public void CreateStoreModel_creates_store_model()
        {
            ...
            //model.ProviderInfo.ProviderInvariantName.Should().Be("System.Data.SqlClient");
            //model.ProviderInfo.ProviderManifestToken.Should().Be("2008");
        ...
        public void GenerateModel_genertes_model_and_sets_all_the_properties()
        {
            ...
            //databaseMapping.Database.Should().BeSameAs(storeModel);
            //databaseMapping.Model.Should().NotBeNull();
        ...
        public void Mapping_context_created_with_CreateMappingContext_will_pluralize_if_pluralization_enabled()
        {
            ...
            //mappingContext[entityType].Name.Should().Be("entity");
            //mappingContext[entitySet].Name.Should().Be("entitySets");
        }
        ...
        //    mappingContext[entityType].Name.Should().Be("entities");
        //    mappingContext[entitySet].Name.Should().Be("entitySet");
        }
